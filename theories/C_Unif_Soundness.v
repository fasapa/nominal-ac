...
Proof.
  ...
  inverts H; repeat split~; intros.
    ...
    case (atom_eqdec ((!pi) $ a) a0); intro H6. case (var_eqdec X X0); intro H7.
...
(** Preservation of solutions by equ\_sys *) 
(**
...
Proof.
  ...
  case (atom_eqdec a a0); intro H2. rewrite H2. apply fresh_Ab_1.
  ...
  gen Q. case (var_eqdec X v); trivial. intros H2 Q.
  rewrite <- H2. clear H2.
...
(** Preservation of solutions by unif\_step *) 
(**
...
(** Characterisation of equations that are in normal forms of equ\_sys *)
(**
...
(** Equations in a sucessful leaf by equ\_sys *)
(**
